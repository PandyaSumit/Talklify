...
import { encryptMeetingLink } from '@/lib/encryption'
...
export async function POST(request: Request) {
  try {
    ...
    const sessions = [
      {
        ...
        meetingLinkEncrypted: encryptMeetingLink('https://zoom.us/j/123456789'),
        category: 'Tech',
      ...
      },
      {
        ...
        meetingLinkEncrypted: encryptMeetingLink('https://meet.google.com/abc-defg-hij'),
        category: 'Tech',
      ...
      },
      {
        ...
        meetingLinkEncrypted: encryptMeetingLink('https://teams.microsoft.com/l/meetup-join/123'),
        category: 'Tech',
      ...
      },
      {
        ...
        timezone: Intl.DateTimeFormat().resolvedOptions().timeZone,
        meetingPlatform: 'Zoom',
        meetingLinkEncrypted: encryptMeetingLink('https://zoom.us/j/987654321'),
        category: 'Design',
      ...
      },
      {
        ...
        timezone: Intl.DateTimeFormat().resolvedOptions().timeZone,
        meetingPlatform: 'Zoom',
        meetingLinkEncrypted: encryptMeetingLink('https://zoom.us/j/111222333'),
        category: 'Tech',
    ...
    // Delete existing test sessions to ensure clean state
