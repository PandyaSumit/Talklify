          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
              >
                <option value="ATTENDEE">Attend sessions</option>
                <option value="HOST">Host sessions</option>
                <option value="BOTH">Both attend and host</option>
              </select>
            </div>
          </div>
